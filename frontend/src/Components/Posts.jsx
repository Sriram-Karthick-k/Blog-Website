...
function Posts(props) {
  useEffect(() => {
    ...
    document.getElementById(props.id).innerHTML += "<a href=" + props.postLink + ">read more...</a>"
  }, [])
  return (
    <div className="container posts">
      <div className="post-content row">
        {
          props.image ?
            <a href={props.postLink} className="col col-lg-12 col-md-12 col-sm-12 col-12">
        ...
        <div className="post-text-holder col col-lg-12 col-md-12 col-sm-12 col-12">
          <a href={props.postLink}><h1 className="post-title" >{props.title}</h1></a>
      ...
      <div className="post-details row">
        <div className="post-details-top row">
          <div className="author-details-holder col col-lg-6 col-md-6 col-sm-12 col-12">
            <a href={props.userLink} className="author-image">
              <img className="image" src={props.authorImage} alt="face" />
            </a>
            <div className="author-details">
              <div className="nick-name"> <a className="text" href={props.userLink}>{props.nickName}</a> </div>
              <div className="time">
                <p>{props.time}</p>
              </div>
            </div>
          ...
          <div className="like-details col col-lg-6 col-sm-12 col-md-6 col-12">
            <div className={props.action.view ? "icon active" : "icon"} >
              <i className="fas fa-eye"></i>
              <p className="icon-text" >{props.views}</p>
            </div>
            <div className={props.action.disLiked ? "icon active" : "icon"} data-toggle={props.loggedIn === true ? "" : "modal"} data-target={props.loggedIn === true ? "" : "#modalCenterSignIn"}>
              <i className="fas fa-thumbs-down"></i>
              <p className="icon-text">{props.disLikes}</p>
            </div>
            <div className={props.action.liked ? "icon active" : "icon"} data-toggle={props.loggedIn === true ? "" : "modal"} data-target={props.loggedIn === true ? "" : "#modalCenterSignIn"}>
